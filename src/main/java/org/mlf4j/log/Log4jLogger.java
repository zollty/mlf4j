 ...
 * @since 2013-6-22
 */
public class Log4jLogger implements org.mlf4j.log.Logger, LoggerSupport, Serializable {
    ...
    public void log(String callerFQCN, org.mlf4j.log.Level lev, Throwable t, Object msg, Object... msgParams) {
        Level level;
        if (org.mlf4j.log.Level.TRACE.isGreaterOrEqual(lev)) {
            level = Level.TRACE;
        }
        else if (org.mlf4j.log.Level.DEBUG.isGreaterOrEqual(lev)) {
            level = Level.DEBUG;
        }
        else if (org.mlf4j.log.Level.INFO.isGreaterOrEqual(lev)) {
            level = Level.INFO;
        }
        else if (org.mlf4j.log.Level.WARN.isGreaterOrEqual(lev)) {
            level = Level.WARN;
        }
        else if (org.mlf4j.log.Level.ERROR.isGreaterOrEqual(lev)) {
            level = Level.ERROR;
        }
        else {
