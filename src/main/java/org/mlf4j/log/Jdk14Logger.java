...
import org.mlf4j.log.LogFactory.LogManager;
 ...
 * @since 2014-6-9
 */
public class Jdk14Logger implements org.mlf4j.log.Logger, LoggerSupport, Serializable {
    ...
    @Override
    public org.mlf4j.log.Logger newInstance(String name) {
        return new Jdk14Logger(name);
    }

    public static Level getLevel(){
        if(LogManager.getThreshold().equals(org.mlf4j.log.Level.ERROR)){
            return Level.SEVERE;
        }
        if(LogManager.getThreshold().equals(org.mlf4j.log.Level.WARN)){
            return Level.WARNING;
        }
        if(LogManager.getThreshold().equals(org.mlf4j.log.Level.INFO)){
            return Level.INFO;
        }
        if(LogManager.getThreshold().equals(org.mlf4j.log.Level.DEBUG)){
            return Level.FINE;
        }
        if(LogManager.getThreshold().equals(org.mlf4j.log.Level.TRACE)){
            return Level.FINEST;
        }
        if(LogManager.getThreshold().equals(org.mlf4j.log.Level.ALL)){
            return Level.ALL;
        }
        if(LogManager.getThreshold().equals(org.mlf4j.log.Level.OFF)){
            return Level.OFF;
        }
        return Level.INFO;
    }
    ...
    @Override
    public void log(String callerFQCN, org.mlf4j.log.Level level, Throwable t, Object message,
            Object... msgParams) {
        Level julLevel;
        if (level == null) {
            julLevel = getLevel();
        }
        if (level.equals(org.mlf4j.log.Level.ERROR)) {
            julLevel = Level.SEVERE;
        }
        else if (level.equals(org.mlf4j.log.Level.WARN)) {
            julLevel = Level.WARNING;
        }
        else if (level.equals(org.mlf4j.log.Level.INFO)) {
            julLevel = Level.INFO;
        }
        else if (level.equals(org.mlf4j.log.Level.DEBUG)) {
            julLevel = Level.FINE;
        }
        else if (level.equals(org.mlf4j.log.Level.TRACE)) {
            julLevel = Level.FINEST;
        }
        else if (level.equals(org.mlf4j.log.Level.ALL)) {
            julLevel = Level.ALL;
        }
        else if (level.equals(org.mlf4j.log.Level.OFF)) {
            julLevel = Level.OFF;
        }
        else {
